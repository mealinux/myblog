        ...
        <div class="container">
          ...
          <form method="post" action="" enctype="multipart/form-data">
            ...
            <div class="row">
              ...
              <div class="col-md-10">
                <input type="text" class="form-control" name="title" placeholder="örnek:laravel" required="required">
              </div>
              <div class="col-md-1">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <textarea required="required" class="form-control" name="special_note" data-parsley-trigger="keyup" data-parsley-minlength="20" data-parsley-maxlength="100"></textarea>
              </div>
              <div class="col-md-4">
